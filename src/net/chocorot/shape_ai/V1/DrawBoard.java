...
public class DrawBoard extends JFrame {
    ...
    private JMenuBar createMenuBar() {
        ...
        JMenuItem calculateMenuItem = new JMenuItem("Calculate");
        calculateMenuItem.addActionListener(e -> {
            ...
            ai.calculateMatrix(pixelMatrix);
        });
    ...
    private void setupKeyBindings() {
        ...
        actionMap.put("calculate", new AbstractAction() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                ai.calculateMatrix(pixelMatrix);  // Trigger calculateMatrix when Ctrl + S is pressed
            }
        });
...
//        weightReset();
    ...
    private static void weightReset() throws IOException {
        long[][] weightMatrix = new long[drawBoardSize*drawBoardSize][1];
